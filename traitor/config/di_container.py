from typing import Type, Any, Optional, Awaitable

from dependency_injector import containers, providers
from dependency_injector.resources import Resource

from traitor.config.config import *
...
class Container(containers.DynamicContainer):
    ...
    # db = providers.Resource(Database, path=config.db.CONNECTION)
    # db = providers.Resource(
    #     lambda cfg: Database(path=cfg.db.host()),  # read config lazily
    #     cfg=config,
    # )
